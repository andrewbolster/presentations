import{d as _,M as u,I as h,f as n,g as t,t as s,B as r,F as f,N as g,o as l,i as v,e as x,A as b}from"../modules/vue-D6AE_F9i.js";import{g as N,e as y,c as m}from"../index-aSTIun2T.js";import{_ as k}from"./NoteDisplay.vue_vue_type_style_index_0_lang-BKgLGIvE.js";import"../modules/shiki-CI77qMfn.js";const w={id:"page-root"},B={class:"m-4"},L={class:"mb-10"},T={class:"text-4xl font-bold mt-2"},V={class:"opacity-50"},H={class:"text-lg"},M={class:"font-bold flex gap-2"},S={class:"opacity-50"},A={key:0,class:"border-main mb-8"},z=_({__name:"print",setup(C){const{slides:d,total:p}=N();u(`
@page {
  size: A4;
  margin-top: 1.5cm;
  margin-bottom: 1cm;
